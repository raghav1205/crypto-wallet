...
const MnemonicDisplay = ({
  ...
  return (
    <>
      <h3 className="text-4xl mb-3 text-center font-semibold">
      ...
      >
        ...
        <p
          className="w-[98%] mx-auto border-[#494b55] border-t flex justify-center  pt-2 text-sm text-opacity-60 text-gray-100"
          
        >
          {cardClicked ? "Copied!" : "Click anywhere on this card to copy"}
        </p>
      </div>

      <button
        className=" btn btn-green mt-[3rem]"
        onClick={() => handleProceedClick("addWallet")}
      >
        Proceed
      </button>
    </>
